    ...
    <div class="bg-white rounded-4 shadow-sm p-4 w-100">
        ...
        @else
            <div class="hc-empty-state">
                ...
                <h3 class="hc-empty-title">No Medical Records</h3>
                <p class="hc-empty-text">Your health record archive is currently empty. Medical reports and session snapshots will appear here as they are generated by your healthcare provider.</p>
            </div>
        @endif
    </div>
</main>
