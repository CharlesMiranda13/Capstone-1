    ...
    @if($customerCount >= 2)
        <div class="alert-banner alert-banner-danger">
            ...
            <div class="alert-banner-action">
                <a href="{{ route('subscribe.show', 'pro solo') }}" class="btn-banner btn-banner-danger">Upgrade Now</a>
            </div>
        </div>
    @else
        <div class="alert-banner alert-banner-info">
            ...
            <div class="alert-banner-action">
                <a href="{{ route('subscribe.show', 'pro solo') }}" class="btn-banner btn-banner-primary">Subscribe Now</a>
            </div>
        </div>
    @endif
@endif
